...
Установка подтверждена разработчиком. На 21 сентября, 11:13 UTC, публично
проверены HTTP 200 у главной, магазина и обоих health; HSTS включён со сроком
30 секунд без includeSubDomains/preload. Осталось исправить `HSTS_SECONDS`
на 300. Блок установки ниже повторять не нужно. GitHub CI коммита `53940bf`
