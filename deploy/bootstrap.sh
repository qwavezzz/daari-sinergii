...
install -d -o dari -g www-data -m 0750 /srv/dari/releases /srv/dari/shared /srv/dari/shared/media /srv/dari/shared/private-media /srv/dari/shared/static /srv/dari/backups
